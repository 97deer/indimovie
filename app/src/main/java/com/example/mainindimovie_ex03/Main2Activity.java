...
public class Main2Activity extends AppCompatActivity {
    ...
    //위시리스트에서 저장된 위시리스트 개수 가져오기 위한 API
    ...
    //예매내역에서 저장된 예매내역 개수 가져오기 위한 API
    ...
    //예매내역에서 상영시간 지난 건 내가 본 영화에 포함하기 위한 API(시간 비교)
    ...
    //예매내역에서 상영시간 지난 건 내가 본 영화에 포함하기 위한 API(디비에 추가)
