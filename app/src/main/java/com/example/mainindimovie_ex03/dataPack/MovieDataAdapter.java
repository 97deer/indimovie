...
public class MovieDataAdapter extends RecyclerView.Adapter<MovieDataAdapter.MovieDataHolder> {
    ...
    public MovieDataAdapter(ArrayList<MovieDataDo> list, Context context) {
    ...
    public MovieDataHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_main_home_movie, viewGroup, false);
    ...
    class MovieDataHolder extends RecyclerView.ViewHolder {
        ...
        public MovieDataHolder(final View itemview) {
            ...
            //예매하기 클릭시 회원 나이와 등급 비교해서 예매가능, 불가 하도록
