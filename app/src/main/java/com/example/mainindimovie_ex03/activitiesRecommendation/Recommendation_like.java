...
// 위시리스트를 통해 영화 추천 받을 수 있는 Activity
// 회원의 위시리스트의 장르값을 받아서 현재상영작 중 같은 장르값인
// 영화를 가장가까운 영화관, 시간을 리스트로 추천
public class Recommendation_like extends AppCompatActivity {
    ImageButton delete;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recommendation_like);
        delete = findViewById(R.id.recommendation_delete_btn);
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Recommendation_like.super.onBackPressed();
            }
        });
        tname = findViewById(R.id.tname);

        //RecommendationMovieActivity에서 받은 String형 위치값을  Double로 바꿈
    ...
    public class getRecom extends AsyncTask<String, Double, String> {
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                HttpGet httpget = new HttpGet(api.API_URL+"/movie/getJangRecommdation2?t_lat=" + latitude1 + "&t_lng=" + longitude1 + "&u_id=" + StaticValues.u_id+"&mt_time="+mt_time);
