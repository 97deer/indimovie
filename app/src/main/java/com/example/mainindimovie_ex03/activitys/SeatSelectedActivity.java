...
//영화, 영화관, 날짜, 시간 선택 후 좌석 선택 Acitivity
//웹뷰 사용해서 웹 가져옴 (웹은 JavaScript로 작성)
public class SeatSelectedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //MovieReserActivity에서 받아온 값 변수에 저장하기
    ...
    //SeatPersonSelected에서 받아온 값 onActivityResult로 가져오기
