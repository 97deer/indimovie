...
//ReservationListActivity -> ReservationDeListActivity
//해당 예매 리스트에서 좌석 별 취소 가능한 Acitivity
public class ReservationDeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ReservationListActivity에서 가져온 mt_id값 변수에 저장
