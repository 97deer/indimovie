...
//영화를 예매하기 위한 Acitivity  (앱에서 '예매하기' 버튼 클릭시)
public class MovieReserActivity extends AppCompatActivity {
    ...
    //MovieReserDatePickerActivity에서 받아온 값 저장하는 변수
    String select_date = "";

    //movieDetailPresentActivity에서 받아온 값 저장하는 변수
    String movie_idd = "";
    ...
    private void setDateTab() {
        ...
        //해당 페이지에서 영화 선택탭에서 가져온것
        String movietitle = getIntent().getStringExtra("movietitle");
        if (movietitle != null) {
            movieText.setText(movietitle);
        }

        //영화 상세 페이지에서 예매하기 선택해서 가져온것
    ...
    //onActivityResult는 Acitivty에서 값을 가져오는데 그 값을 호출한 Activity에서 받아올 수 있다.
    @Override
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case SIG_DATE_PICKER:
                    ...
                    //MovieReserDatePickerActivity에서 받아온 값 저장
                ...
                case SIG_MOVIE_PICKER:
                    ...
                    //MovieReserSelectedActivity 에서 받아온 값 저장
                ...
                case SIG_THEATER_PICKER:
                    ...
                    //MovieReserTheaterSelectedActivity에서 받아온 값 저장
                    String theatertext = data.getStringExtra("theatername");

                    if (theatertext != null) {
                        spotText.setText(theatertext);
                    }
                    //MovieReserTheaterSelectedActivity에서  넘긴값 받음
    ...
    //영화, 영화관, 날짜 선택 후 상영관과 시간을 가져오는 API
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    //상영시간은 버튼식으로 나열되어 있는데 이 값을 넣기 위해 ArratList로!
                ...
                adapter.setOnReserMovieTimeListListener(new ReserMovieTimeListAdapter.OnReserMovieTimeListListener() {
                    ...
                    public void OnClicked(Button button) {
                        ...
                        //getTag는 ArratList형식이라서 형변환 (ReserMovieTimeSlideAdapter에서 가져온 값이다)
